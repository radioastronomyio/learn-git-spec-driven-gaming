...
standard from the project template; only the descriptions should
be project-specific.
-->
...
```markdown
<repo-name>/
├── assets/            # Project images, banners, diagrams
├── docs/              # Documentation
├── internal-files/    # Source materials (one-pagers, charters, GDRs)
├── recycle/           # Agent trash can (gitignored)
...
Required sections: Frontmatter, Title, Tagline + intro, Overview,
Project Status, Architecture, Repository Structure, Getting Started,
Last Updated footer.
...
Repo URL: https://github.com/MSP4-LLC/learn-git-breakout
-->
